...
namespace TBTK
{
    public class AStar
    {
        ...
        public static bool IgnoreAllUnit(int flag)
        {
            return flag == -2;
        }

        public static bool CantBypassUnit(int flag)
        {
            return flag == -1;
        }

        public static bool BypassFriendlyUnit(int flag)
        {
            return flag >= 0;
        }
        ...
        //~ }
        public static List<Node> SearchWalkableNode(Node originNode, Node destNode, int bypassUnit = -1,
            bool bypassObs = true, bool returnNearest = true)
        {
