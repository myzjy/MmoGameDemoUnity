        ...
        protected override void ThreadFunc()
        {
            try
            {
                ...
                using (System.IO.Stream fs =
                       HttpManager.IOService.CreateFileStream(this.CurrentRequest.CurrentUri.LocalPath,
                ...
                using (StreamList stream = new StreamList(new BufferPoolMemoryStream(), fs))
                {
                    ...
                    base.CurrentRequest.Response = new HttpResponse(base.CurrentRequest, stream,
                        base.CurrentRequest.UseStreaming, false);
