...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Crypto.Engines
{
	...
	*/
        ...
        : IBlockCipher
    {
        ...
        private static readonly byte[] SboxDefault =
        {
         ...
         */
        private static readonly byte[] ESboxTest =
        {
        ...
        private static readonly byte[] ESboxA =
        {
        ...
        private static readonly byte[] ESboxB =
        {
        ...
        private static readonly byte[] ESboxC =
        {
        ...
        private static readonly byte[] ESboxD =
        {
        ...
        //S-box for digest
        private static readonly byte[] DSboxTest =
        {
            0x4, 0xA, 0x9, 0x2, 0xD, 0x8, 0x0, 0xE, 0x6, 0xB, 0x1, 0xC, 0x7, 0xF, 0x5, 0x3,
            0xE, 0xB, 0x4, 0xC, 0x6, 0xD, 0xF, 0xA, 0x2, 0x3, 0x8, 0x1, 0x0, 0x7, 0x5, 0x9,
            0x5, 0x8, 0x1, 0xD, 0xA, 0x3, 0x4, 0x2, 0xE, 0xF, 0xC, 0x7, 0x6, 0x0, 0x9, 0xB,
        ...
        private static readonly byte[] DSboxA =
        {
        ...
        private byte[] _s = SboxDefault;
        private int[] _workingKey = null;

        static Gost28147Engine()
        {
            AddSBox("Default", SboxDefault);
            AddSBox("E-TEST", ESboxTest);
            AddSBox("E-A", ESboxA);
            AddSBox("E-B", ESboxB);
            AddSBox("E-C", ESboxC);
            AddSBox("E-D", ESboxD);
            AddSBox("D-TEST", DSboxTest);
            AddSBox("D-A", DSboxA);
        }
		...
		*/
            ...
            int outOff)
        {
            ...
            Gost28147Func(_workingKey, input, inOff, output, outOff);
...
//			return om << 11 | om >>> (32-11); // 11-leftshift
		...
		*/
        ...
        {
            byte[] sBox =
                (byte[])SBoxes[BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.ToUpperInvariant(sBoxName)];
