...
namespace ZJYFrameWork.Editors.Inspector
{
    ...
    public class BaseComponentInspector : GameFrameworkInspector
    {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                EditorGUILayout.BeginVertical("box");
                {
                    ...
                    int logHelperSelectedIndex =
                        EditorGUILayout.Popup("Log Helper", logHelperTypeNameIndex, logHelperTypeNames);
                    if (logHelperSelectedIndex != logHelperTypeNameIndex)
                    {
                        logHelperTypeNameIndex = logHelperSelectedIndex;
                        logHelperTypeName.stringValue = logHelperSelectedIndex <= 0
                            ? null
                            : logHelperTypeNames[logHelperSelectedIndex];
                    }
