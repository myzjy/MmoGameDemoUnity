...
public class Reporter : MonoBehaviour
{
    ...
    void drawInfo_enableDisableToolBarButtons()
    {
        ...
        if (GUILayout.Button(copyAllContent, (showCopyAllButton) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2), GUILayout.Height(size.y * 2)))
        {
    ...
    void drawToolBar()
    {
        ...
        if (showCopyAllButton)
        {
            if (GUILayout.Button(copyAllContent, barStyle, GUILayout.Width(size.x * 2), GUILayout.Height(size.y * 2)))
            {
                ...
                logs.ForEach(l =>
                    allLogsToClipboard += l.condition + System.Environment.NewLine + System.Environment.NewLine +
                                          l.stacktrace);
