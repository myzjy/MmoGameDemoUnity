...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Crypto.Engines
{
	...
	*/
        ...
        : IBlockCipher
    {
        ...
        *
        */
        private static readonly uint[] Sbox11110 = new uint[]
        {
        ...
        private static readonly uint[] Sbox44404 = new uint[]
        {
        ...
        private static readonly uint[] Sbox20222 = new uint[]
        {
        ...
        private static readonly uint[] Sbox33033 = new uint[]
        {
        ...
        private static void CamelliaF2(uint[] s, uint[] skey, int keyoff)
        {
            ...
            u = Sbox44404[(byte)t1];
            u ^= Sbox33033[(byte)(t1 >> 8)];
            u ^= Sbox20222[(byte)(t1 >> 16)];
            u ^= Sbox11110[(byte)(t1 >> 24)];
            t2 = s[1] ^ skey[1 + keyoff];
            v = Sbox11110[(byte)t2];
            v ^= Sbox44404[(byte)(t2 >> 8)];
            v ^= Sbox33033[(byte)(t2 >> 16)];
            v ^= Sbox20222[(byte)(t2 >> 24)];
