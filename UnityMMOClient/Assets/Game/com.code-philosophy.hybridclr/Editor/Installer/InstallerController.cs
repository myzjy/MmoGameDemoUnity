...
namespace HybridCLR.Editor.Installer
{
    ...
    public class InstallerController
    {
        ...
        {
            string packageJson = $"{SettingsUtil.ProjectDir}/Assets/Game/{SettingsUtil.PackageName}/package.json";
        ...
        private void RunInitLocalIl2CppData(string editorIl2cppPath, string libil2cppWithHybridclrSourceDir, UnityVersion version)
        {
            ...
            {
                Debug.LogError($"与当前版本不兼容，最低兼容版本n: {GetCurrentUnityVersionMinCompatibleVersionStr()}");
                return;
            }
            string workDir = SettingsUtil.HybridCLRDataDir;
            Directory.CreateDirectory(workDir);
