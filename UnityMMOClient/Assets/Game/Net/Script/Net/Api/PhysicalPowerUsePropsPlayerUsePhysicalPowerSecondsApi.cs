...
namespace ZJYFrameWork.Net
{
    ...
    /// 使用体力
    /// </summary>
    public class PhysicalPowerUsePropsPlayerUsePhysicalPowerSecondsApi : ApiHttp<
        PhysicalPowerUsePropsPlayerUsePhysicalPowerSecondsRequest,
        PhysicalPowerUsePropsPlayerUsePhysicalPowerSecondsResponse, Error>
    {
