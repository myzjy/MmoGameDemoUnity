        ...
        : IAsymmetricBlockCipher
    {
		...
		*/
            ...
            ICipherParameters parameters)
        {
            ...
            {
                NaccacheSternPrivateKeyParameters priv = (NaccacheSternPrivateKeyParameters)_key;
                ...
                for (int i = 0; i < primes.Count; i++)
                {
                    ...
                    _lookup[i] =
                        BestHTTP.SecureProtocol.Org.BouncyCastle.Utilities.Platform.CreateArrayList(actualPrimeValue);
...
//			Array.Clear(output, 0, output.Length);
            byte[] output = new byte[_key.Modulus.BitLength / 8 + 1];
