    ...
    public abstract partial class AssetBundleLoaderBase
    {
        ...
        public class AssetBundleHolder : IBundle
        {
            ...
            public AssetBundleHolder(AssetBundleHolder holderSource)
            {
                ...
                this.assetBundle = holderSource.assetBundle;
                this.assetBundleName = holderSource.assetBundle.name;
                Name = holderSource.assetBundleName;
            ...
            {
                return Instance.GetAssetBundleLoaderImpl().LoadAsset(assetBundle,
                    assetBundleName, assetName, type);
            }

            public void LoadScene(string name, LoadSceneMode mode)
            {
                Instance.GetAssetBundleLoaderImpl().LoadScene(assetBundle, assetBundleName, name, mode);
            }
            ...
            {
                var loader = Instance;
                loader.GetAssetBundleLoaderImpl().LoadAssetAsync(loader,assetBundle, assetBundleName, assetName, type, callObjBack);
            }
        }
    }
}