...
#if UNITY_EDITOR
            HostType type = (HostType)UnityEditor.EditorPrefs.GetInt("MmoGame/Tools/Skip Server Select/", (int)HostType.Develop);
        	...
        	public void SetHost(HostType type)
		{
			...
			switch (_hostType)
			{
				case HostType.Develop:
					...
					break;
				case HostType.Test:
					ApiHttpsBaseUrl = "http://fz-game-ttl-test.focusgames.cn";
					break;
