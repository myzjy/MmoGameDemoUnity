...
namespace ZJYFrameWork.Debugger.Widows.Model
{
    public abstract class ScrollableDebuggerWindowBase:IDebuggerWindow
    {
        ...
        protected static string GetByteLengthString(long byteLength)
        {
            ...
            return byteLength < 1152921504606846976L ? // 2 ^ 60
                StringUtils.Format("{} PB", (byteLength / 1125899906842624f).ToString("F2")) : StringUtils.Format("{} EB", (byteLength / 1152921504606846976f).ToString("F2"));
        }
    }
}