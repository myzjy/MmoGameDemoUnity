...
namespace AssetBundles
{
    public class AssetsPathMappingEditor
    {
        ...
        public static void BuildPathMapping(AssetBundleManifest manifest)
        {
            ...
            ProsessVariant(allAssetbundles, allVariants, out var assetbundlesWithoutVariant,
                out var variantWithoutDeplicate);
            ...
            foreach (string assetbundle in variantWithoutDeplicate)
            {
                ...
                foreach (string assetPath in assetPaths)
                {
                    ...
                    string mappingItem = string.Format("{0}{1}{2}", RemoveVariantSuffix(assetbundle), PATTREN,
                        packagePath);
                    mappingList.Add(mappingItem);
                }
            }
