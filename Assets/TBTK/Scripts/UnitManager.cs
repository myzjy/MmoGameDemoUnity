...
namespace TBTK
{
    ...
    public class UnitManager : MonoBehaviour
    {
        ...
        public static List<Unit> GetAllUnitList()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < instance.factionList.Count; i++)
                    instance.allUnitList.AddRange(instance.factionList[i].unitList);
        ...
        public static Faction GetFaction(int idx)
        {
            return instance.factionList[idx];
        }
        ...
        public static bool IsDeploymentDone()
        {
            ...
            List<Node> deploymentNodeList =
                GridManager.GetDeploymentNode(instance.factionList[instance.deployingFacIdx].factionID);
            for (int i = 0; i < deploymentNodeList.Count; i++)
            {
                if (deploymentNodeList[i].unit == null)
                {
                    hasEmptyNode |= true;
                    break;
                }
        ...
        public static bool DeployUnit(Node node, int idx = 0)
        {
            return instance._DeployUnit(node, idx);
        }
        ...
        public static bool RequireManualDeployment()
        {
            return instance._RequireManualDeployment() >= 0;
        }
        ...
        public static bool DeployingUnit()
        {
            return instance.deployingFacIdx >= 0;
        }

        public static int GetDeployingFacIdx()
        {
            return instance.deployingFacIdx;
        }

        public static int GetDeployingUnitIdx()
        {
            return instance.deployingUnitIdx;
        }

        public static void SetDeployingUnitIdx(int idx)
        {
            instance.deployingUnitIdx = idx;
        }
        ...
        public static void CheckAITrigger(Unit unit)
        {
            instance._CheckAITrigger(unit);
        }
        ...
        public static void EndTurn_UnitPerTurn(int turnIdx)
        {
            ...
            if (instance.allUnitList[turnIdx] == null || instance.allUnitList[turnIdx].hp <= 0)
            {
                //in case the unit is destroy by dot or other effect
                TurnControl.EndTurn();
                return;
            }
            ...
            if (instance.allUnitList[turnIdx].playableUnit)
            {
                ...
                for (int i = 0; i < instance.factionList.Count; i++)
                {
                    ...
                    {
                        TBTK.OnSelectFaction(instance.factionList[i]);
                        break;
                    }
                }
            }
        ...
        public static int GetCurrentFactionID()
        {
            return instance.currentFacID;
        }
        ...
        public static void SelectNextUnit()
        {
            ...
            if (TurnControl.IsFactionPerTurn())
            {
                if (GetSelectedFaction().GetMoveCount() >= TurnControl.GetUnitLimit())
                    TBSelectUnit(instance.selectedUnit);
                else TBSelectUnit(instance.factionList[instance.currentFacID].GetNextUnitInTurn());
            }
        }


        public static void TBSelectUnit(Unit unit)
        {
            instance._SelectUnit(unit);
        } //by non UI-user event
        ...
        public static float GetAuraAttackMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraAttackMul(unit, node);
        }

        public static float GetAuraDefenseMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDefenseMul(unit, node);
        }

        public static float GetAuraHitMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraHitMul(unit, node);
        }

        public static float GetAuraDodgeMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDodgeMul(unit, node);
        }

        public static float GetAuraDmgHPMinMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDmgHPMinMul(unit, node);
        }

        public static float GetAuraDmgHPMaxMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDmgHPMaxMul(unit, node);
        }

        public static float GetAuraDmgAPMinMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDmgAPMinMul(unit, node);
        }

        public static float GetAuraDmgAPMaxMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDmgAPMaxMul(unit, node);
        }

        public static float GetAuraCritChanceMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCritChanceMul(unit, node);
        }

        public static float GetAuraCritReducMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCritReducMul(unit, node);
        }

        public static float GetAuraCritMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCritMul(unit, node);
        }

        public static float GetAuraCDmgMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCDmgMul(unit, node);
        }

        public static float GetAuraCHitPenaltyMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCHitPenaltyMul(unit, node);
        }

        public static float GetAuraCCritPenaltyMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCCritPenaltyMul(unit, node);
        }

        public static float GetAuraODmgMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraODmgMul(unit, node);
        }

        public static float GetAuraOHitPenaltyMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraOHitPenaltyMul(unit, node);
        }

        public static float GetAuraOCritPenaltyMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraOCritPenaltyMul(unit, node);
        }

        public static float GetAuraAttackRangeMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraAttackRangeMul(unit, node);
        }

        public static float GetAuraAttackRangeMinMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraAttackRangeMinMul(unit, node);
        }

        public static float GetAuraMoveRangeMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraMoveRangeMul(unit, node);
        }

        public static float GetAuraTurnPriorityMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraTurnPriorityMul(unit, node);
        }

        public static float GetAuraSightMul(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraSightMul(unit, node);
        }


        public static float GetAuraAttackMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraAttackMod(unit, node);
        }

        public static float GetAuraDefenseMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDefenseMod(unit, node);
        }

        public static float GetAuraHitMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraHitMod(unit, node);
        }

        public static float GetAuraDodgeMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDodgeMod(unit, node);
        }

        public static float GetAuraDmgHPMinMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDmgHPMinMod(unit, node);
        }

        public static float GetAuraDmgHPMaxMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDmgHPMaxMod(unit, node);
        }

        public static float GetAuraDmgAPMinMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDmgAPMinMod(unit, node);
        }

        public static float GetAuraDmgAPMaxMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraDmgAPMaxMod(unit, node);
        }

        public static float GetAuraCritChanceMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCritChanceMod(unit, node);
        }

        public static float GetAuraCritReducMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCritReducMod(unit, node);
        }

        public static float GetAuraCritMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCritMod(unit, node);
        }

        public static float GetAuraCDmgMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCDmgMod(unit, node);
        }

        public static float GetAuraCHitPenaltyMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCHitPenaltyMod(unit, node);
        }

        public static float GetAuraCCritPenaltyMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraCCritPenaltyMod(unit, node);
        }

        public static float GetAuraODmgMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraODmgMod(unit, node);
        }

        public static float GetAuraOHitPenaltyMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraOHitPenaltyMod(unit, node);
        }

        public static float GetAuraOCritPenaltyMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraOCritPenaltyMod(unit, node);
        }

        public static float GetAuraAttackRangeMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraAttackRangeMod(unit, node);
        }

        public static float GetAuraAttackRangeMinMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraAttackRangeMinMod(unit, node);
        }

        public static float GetAuraMoveRangeMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraMoveRangeMod(unit, node);
        }

        public static float GetAuraTurnPriorityMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraTurnPriorityMod(unit, node);
        }

        public static float GetAuraSightMod(Unit unit, Node node)
        {
            return GetFactionWithID(unit.facID).GetAuraSightMod(unit, node);
        }
        ...
        {
            return ((index >= 0 && cachedFactionList.Count > index)
                ? cachedFactionList[index].unitList
                : new List<Unit>());
        }
        ...
        {
            return ((index >= 0 && cachedFactionList.Count > index)
                ? cachedFactionList[index].cachedUnitInfoList
                : new List<CachedUnitInfo>());
        }
    }
    ...
    public class Faction
    {
        ...
        public int
            turnIdx; //indicate which unit in the faction is being selected right now, used in FactionPerTurn only

        public void UpdateTurnIdx(Unit unit)
        {
            turnIdx = unitList.IndexOf(unit);
        }

        [HideInInspector] public int movedUnitCount = 0; //not in used
        ...
        public void CacheUnit_PostGame()
        {
            //called by the faction instance in a game when the game is over
        ...
        public void Init(int facID)
        {
            ...
            for (int i = 0; i < startingUnitList.Count; i++)
            {
                ...
                GameObject unitObj = (GameObject)MonoBehaviour.Instantiate(startingUnitList[i].gameObject,
                    new Vector3(0, 99999, 0), Quaternion.identity);
        ...
        {
            //add unit during runtime (mid-game)
        ...
        public void DeployUnit()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                nodeList.RemoveAt(rand);
                deployingList.RemoveAt(0);
            }
        }
        ...
        public static bool UseAura()
        {
            return Unit.enableAura;
        }

        public float GetAuraAttackMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraAttackMul(node);
            }

            return value;
        }

        public float GetAuraDefenseMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraDefenseMul(node);
            }

            return value;
        }

        public float GetAuraHitMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraHitMul(node);
            }

            return value;
        }

        public float GetAuraDodgeMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraDodgeMul(node);
            }

            return value;
        }

        public float GetAuraDmgHPMinMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraDmgHPMinMul(node);
            }

            return value;
        }

        public float GetAuraDmgHPMaxMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraDmgHPMaxMul(node);
            }

            return value;
        }

        public float GetAuraDmgAPMinMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraDmgAPMinMul(node);
            }

            return value;
        }

        public float GetAuraDmgAPMaxMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraDmgAPMaxMul(node);
            }

            return value;
        }

        public float GetAuraCritChanceMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraCritChanceMul(node);
            }

            return value;
        }

        public float GetAuraCritReducMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraCritReducMul(node);
            }

            return value;
        }

        public float GetAuraCritMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraCritMul(node);
            }

            return value;
        }

        public float GetAuraCDmgMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraCDmgMul(node);
            }

            return value;
        }

        public float GetAuraCHitPenaltyMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraCHitPenaltyMul(node);
            }

            return value;
        }

        public float GetAuraCCritPenaltyMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraCCritPenaltyMul(node);
            }

            return value;
        }

        public float GetAuraODmgMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraODmgMul(node);
            }

            return value;
        }

        public float GetAuraOHitPenaltyMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraOHitPenaltyMul(node);
            }

            return value;
        }

        public float GetAuraOCritPenaltyMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraOCritPenaltyMul(node);
            }

            return value;
        }

        public float GetAuraAttackRangeMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraAttackRangeMul(node);
            }

            return value;
        }

        public float GetAuraAttackRangeMinMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraAttackRangeMinMul(node);
            }

            return value;
        }

        public float GetAuraMoveRangeMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraMoveRangeMul(node);
            }

            return value;
        }

        public float GetAuraTurnPriorityMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraTurnPriorityMul(node);
            }

            return value;
        }

        public float GetAuraSightMul(Unit unit, Node node, float value = 1)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value *= unitList[i].GetAuraSightMul(node);
            }
        ...
        public float GetAuraAttackMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraAttackMod(node);
            }

            return value;
        }

        public float GetAuraDefenseMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraDefenseMod(node);
            }

            return value;
        }

        public float GetAuraHitMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraHitMod(node);
            }

            return value;
        }

        public float GetAuraDodgeMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraDodgeMod(node);
            }

            return value;
        }

        public float GetAuraDmgHPMinMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraDmgHPMinMod(node);
            }

            return value;
        }

        public float GetAuraDmgHPMaxMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraDmgHPMaxMod(node);
            }

            return value;
        }

        public float GetAuraDmgAPMinMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraDmgAPMinMod(node);
            }

            return value;
        }

        public float GetAuraDmgAPMaxMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraDmgAPMaxMod(node);
            }

            return value;
        }

        public float GetAuraCritChanceMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraCritChanceMod(node);
            }

            return value;
        }

        public float GetAuraCritReducMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraCritReducMod(node);
            }

            return value;
        }

        public float GetAuraCritMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraCritMod(node);
            }

            return value;
        }

        public float GetAuraCDmgMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraCDmgMod(node);
            }

            return value;
        }

        public float GetAuraCHitPenaltyMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraCHitPenaltyMod(node);
            }

            return value;
        }

        public float GetAuraCCritPenaltyMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraCCritPenaltyMod(node);
            }

            return value;
        }

        public float GetAuraODmgMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraODmgMod(node);
            }

            return value;
        }

        public float GetAuraOHitPenaltyMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraOHitPenaltyMod(node);
            }

            return value;
        }

        public float GetAuraOCritPenaltyMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraOCritPenaltyMod(node);
            }

            return value;
        }

        public float GetAuraAttackRangeMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraAttackRangeMod(node);
            }

            return value;
        }

        public float GetAuraAttackRangeMinMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraAttackRangeMinMod(node);
            }

            return value;
        }

        public float GetAuraMoveRangeMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraMoveRangeMod(node);
            }

            return value;
        }

        public float GetAuraTurnPriorityMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
                if (unitList[i] != unit) value += unitList[i].GetAuraTurnPriorityMod(node);
            }

            return value;
        }

        public float GetAuraSightMod(Unit unit, Node node, float value = 0)
        {
            if (!UseAura()) return value;
            for (int i = 0; i < unitList.Count; i++)
            {
    ...
    public class SpawnGroup
    {
        ...
        public void Spawn(Faction fac)
        {
            ...
            int limit = (int)Mathf.Min(nodeList.Count, Rand.Range(countMin, countMax));
            int currentCount = 0;
            ...
            while (nodeList.Count > 0 && currentCount < limit)
            {
                ...
                for (int i = 0; i < cloneUnitList.Count; i++)
                {
                    ...
                    spawnedUnitList.Add(UnitManager.PlaceUnit(cloneUnitList[i].gameObject, nodeList[nodeIdx],
                        fac.direction));
                    nodeList.RemoveAt(nodeIdx);
                    currentCount += 1;
                    ...
                    {
                        cloneUnitList.RemoveAt(i);
                        cloneMinList.RemoveAt(i);
                        cloneMaxList.RemoveAt(i);
                        i -= 1;
                        continue;
                    }
                }
            ...
            while (currentCount < limit && nodeList.Count > 0 && cloneUnitList.Count > 0)
            {
                ...
                spawnedUnitList.Add(UnitManager.PlaceUnit(cloneUnitList[unitIdx].gameObject, nodeList[nodeIdx],
                    fac.direction));
                nodeList.RemoveAt(nodeIdx);
                currentCount += 1;
                ...
                {
                    cloneUnitList.RemoveAt(unitIdx);
                    cloneMaxList.RemoveAt(unitIdx);
                    continue;
                }
            }
