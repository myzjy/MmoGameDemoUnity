    ...
    public class PreloadAssetBundleExample : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            GameObject goTemplate =
                bundle.LoadAsset<GameObject>("LoxodonFramework/BundleExamples/Models/Plane/Plane.prefab"); //OK
            GameObject.Instantiate(goTemplate);

            /* Green and Red */
            GameObject[] goTemplates = this.resources.LoadAssets<GameObject>(
                "LoxodonFramework/BundleExamples/Models/Green/Green.prefab",
                "LoxodonFramework/BundleExamples/Models/Red/Red.prefab");
