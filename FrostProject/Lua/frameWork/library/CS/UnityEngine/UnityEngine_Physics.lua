...
---@overload fun(ray:CS.UnityEngine.Ray): CS.UnityEngine.RaycastHit[]
---@overload fun(origin:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3): CS.UnityEngine.RaycastHit[]
---@overload fun(ray:CS.UnityEngine.Ray, maxDistance:number): CS.UnityEngine.RaycastHit[]
---@overload fun(origin:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, maxDistance:number): CS.UnityEngine.RaycastHit[]
---@overload fun(ray:CS.UnityEngine.Ray, maxDistance:number, layerMask:number): CS.UnityEngine.RaycastHit[]
---@overload fun(origin:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, maxDistance:number, layerMask:number): CS.UnityEngine.RaycastHit[]
---@overload fun(ray:CS.UnityEngine.Ray, maxDistance:number, layerMask:number, queryTriggerInteraction:number): CS.UnityEngine.RaycastHit[]
...
---@overload fun(ray:CS.UnityEngine.Ray, results:CS.UnityEngine.RaycastHit[]): number
---@overload fun(ray:CS.UnityEngine.Ray, results:CS.UnityEngine.RaycastHit[], maxDistance:number): number
---@overload fun(origin:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[]): number
---@overload fun(ray:CS.UnityEngine.Ray, results:CS.UnityEngine.RaycastHit[], maxDistance:number, layerMask:number): number
---@overload fun(origin:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[], maxDistance:number): number
---@overload fun(ray:CS.UnityEngine.Ray, results:CS.UnityEngine.RaycastHit[], maxDistance:number, layerMask:number, queryTriggerInteraction:number): number
---@overload fun(origin:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[], maxDistance:number, layerMask:number): number
---@return number
---@param origin CS.UnityEngine.Vector3
---@param direction CS.UnityEngine.Vector3
...
---@overload fun(point1:CS.UnityEngine.Vector3, point2:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3): CS.UnityEngine.RaycastHit[]
---@overload fun(point1:CS.UnityEngine.Vector3, point2:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, maxDistance:number): CS.UnityEngine.RaycastHit[]
---@overload fun(point1:CS.UnityEngine.Vector3, point2:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, maxDistance:number, layerMask:number): CS.UnityEngine.RaycastHit[]
---@return CS.UnityEngine.RaycastHit[]
---@param point1 CS.UnityEngine.Vector3
---@param point2 CS.UnityEngine.Vector3
---@param radius number
...
---@overload fun(ray:CS.UnityEngine.Ray, radius:number): CS.UnityEngine.RaycastHit[]
---@overload fun(origin:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3): CS.UnityEngine.RaycastHit[]
---@overload fun(ray:CS.UnityEngine.Ray, radius:number, maxDistance:number): CS.UnityEngine.RaycastHit[]
---@overload fun(origin:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, maxDistance:number): CS.UnityEngine.RaycastHit[]
---@overload fun(ray:CS.UnityEngine.Ray, radius:number, maxDistance:number, layerMask:number): CS.UnityEngine.RaycastHit[]
---@overload fun(origin:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, maxDistance:number, layerMask:number): CS.UnityEngine.RaycastHit[]
---@overload fun(ray:CS.UnityEngine.Ray, radius:number, maxDistance:number, layerMask:number, queryTriggerInteraction:number): CS.UnityEngine.RaycastHit[]
---@return CS.UnityEngine.RaycastHit[]
---@param origin CS.UnityEngine.Vector3
---@param radius number
---@param direction CS.UnityEngine.Vector3
...
---@overload fun(point0:CS.UnityEngine.Vector3, point1:CS.UnityEngine.Vector3, radius:number): CS.UnityEngine.Collider[]
---@overload fun(point0:CS.UnityEngine.Vector3, point1:CS.UnityEngine.Vector3, radius:number, layerMask:number): CS.UnityEngine.Collider[]
...
---@overload fun(position:CS.UnityEngine.Vector3, radius:number): CS.UnityEngine.Collider[]
---@overload fun(position:CS.UnityEngine.Vector3, radius:number, layerMask:number): CS.UnityEngine.Collider[]
---@return CS.UnityEngine.Collider[]
...
---@overload fun(position:CS.UnityEngine.Vector3, radius:number, results:CS.UnityEngine.Collider[]): number
---@overload fun(position:CS.UnityEngine.Vector3, radius:number, results:CS.UnityEngine.Collider[], layerMask:number): number
---@return number
---@param position CS.UnityEngine.Vector3
---@param radius number
...
---@overload fun(point1:CS.UnityEngine.Vector3, point2:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[]): number
---@overload fun(point1:CS.UnityEngine.Vector3, point2:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[], maxDistance:number): number
---@overload fun(point1:CS.UnityEngine.Vector3, point2:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[], maxDistance:number, layerMask:number): number
---@return number
---@param point1 CS.UnityEngine.Vector3
---@param point2 CS.UnityEngine.Vector3
---@param radius number
...
---@overload fun(ray:CS.UnityEngine.Ray, radius:number, results:CS.UnityEngine.RaycastHit[]): number
---@overload fun(origin:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[]): number
---@overload fun(ray:CS.UnityEngine.Ray, radius:number, results:CS.UnityEngine.RaycastHit[], maxDistance:number): number
---@overload fun(origin:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[], maxDistance:number): number
---@overload fun(ray:CS.UnityEngine.Ray, radius:number, results:CS.UnityEngine.RaycastHit[], maxDistance:number, layerMask:number): number
---@overload fun(origin:CS.UnityEngine.Vector3, radius:number, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[], maxDistance:number, layerMask:number): number
---@overload fun(ray:CS.UnityEngine.Ray, radius:number, results:CS.UnityEngine.RaycastHit[], maxDistance:number, layerMask:number, queryTriggerInteraction:number): number
---@return number
---@param origin CS.UnityEngine.Vector3
---@param radius number
---@param direction CS.UnityEngine.Vector3
...
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3): CS.UnityEngine.Collider[]
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, orientation:CS.UnityEngine.Quaternion): CS.UnityEngine.Collider[]
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, orientation:CS.UnityEngine.Quaternion, layerMask:number): CS.UnityEngine.Collider[]
---@return CS.UnityEngine.Collider[]
---@param center CS.UnityEngine.Vector3
---@param halfExtents CS.UnityEngine.Vector3
---@param orientation CS.UnityEngine.Quaternion
...
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, results:CS.UnityEngine.Collider[]): number
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, results:CS.UnityEngine.Collider[], orientation:CS.UnityEngine.Quaternion): number
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, results:CS.UnityEngine.Collider[], orientation:CS.UnityEngine.Quaternion, mask:number): number
---@return number
---@param center CS.UnityEngine.Vector3
---@param halfExtents CS.UnityEngine.Vector3
---@param results CS.UnityEngine.Collider[]
...
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[]): number
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[], orientation:CS.UnityEngine.Quaternion): number
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[], orientation:CS.UnityEngine.Quaternion, maxDistance:number): number
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, results:CS.UnityEngine.RaycastHit[], orientation:CS.UnityEngine.Quaternion, maxDistance:number, layerMask:number): number
---@return number
---@param center CS.UnityEngine.Vector3
---@param halfExtents CS.UnityEngine.Vector3
---@param direction CS.UnityEngine.Vector3
...
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3): CS.UnityEngine.RaycastHit[]
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, orientation:CS.UnityEngine.Quaternion): CS.UnityEngine.RaycastHit[]
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, orientation:CS.UnityEngine.Quaternion, maxDistance:number): CS.UnityEngine.RaycastHit[]
---@overload fun(center:CS.UnityEngine.Vector3, halfExtents:CS.UnityEngine.Vector3, direction:CS.UnityEngine.Vector3, orientation:CS.UnityEngine.Quaternion, maxDistance:number, layerMask:number): CS.UnityEngine.RaycastHit[]
---@return CS.UnityEngine.RaycastHit[]
---@param center CS.UnityEngine.Vector3
---@param halfExtents CS.UnityEngine.Vector3
---@param direction CS.UnityEngine.Vector3
...
---@overload fun(point0:CS.UnityEngine.Vector3, point1:CS.UnityEngine.Vector3, radius:number, results:CS.UnityEngine.Collider[]): number
---@overload fun(point0:CS.UnityEngine.Vector3, point1:CS.UnityEngine.Vector3, radius:number, results:CS.UnityEngine.Collider[], layerMask:number): number
---@return number
---@param point0 CS.UnityEngine.Vector3
---@param point1 CS.UnityEngine.Vector3
---@param radius number
