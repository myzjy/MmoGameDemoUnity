...
---@overload fun(direction:CS.UnityEngine.Vector3): CS.UnityEngine.RaycastHit[]
---@overload fun(direction:CS.UnityEngine.Vector3, maxDistance:number): CS.UnityEngine.RaycastHit[]
