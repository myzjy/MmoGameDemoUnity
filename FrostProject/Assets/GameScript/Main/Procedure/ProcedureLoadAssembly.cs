...
#pragma warning restore CS0414
        ...
        protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            Debug.Log("HyBridCLR ProcedureLoadAssembly OnEnter");
...
//             entryMethod.Invoke(appType, objects);
        ...
        private void LoadAssetSuccess(TextAsset textAsset)
        {
            ...
            if (textAsset == null)
            {
                Debug.LogWarning($"Load Assembly failed.");
                return;
            }
        ...
        private unsafe void LoadMetadataAssetSuccess(TextAsset textAsset)
        {
            ...
            try
            {
                ...
                fixed (byte* ptr = dllBytes)
                {
                    ...
                    Debug.LogWarning($"LoadMetadataForAOTAssembly:{assetName}. mode:{mode} ret:{err}");
#endif
                }
            }
            catch (Exception e)
