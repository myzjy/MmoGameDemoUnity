...
namespace GameMain
{
    ...
    public class ProcedurePreload : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            UILoadMgr.Show(UIDefine.UILoadUpdate, StringUtils.Format(LoadText.Instance.Label_Load_Load_Progress, 0));
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            {
                UILoadMgr.Show(UIDefine.UILoadUpdate, StringUtils.Format(LoadText.Instance.Label_Load_Load_Progress, (float)loadCount / totalCount * 100));
            }
            else
            {
                ...
                {
                    UILoadMgr.Show(UIDefine.UILoadUpdate, StringUtils.Format(LoadText.Instance.Label_Load_Load_Progress, progressStr));
                }
            }
        ...
        {
            Debug.LogWarning("Can not preload asset from '{0}' with error message '{1}'.", assetName, errormessage);
        ...
        {
            Debug.Log("Success preload asset from '{0}' duration '{1}'.", assetName, duration);
            _loadedFlag[assetName] = true;
        }
    }
}