...
namespace BestHTTP.SocketIO.Events
{
    ...
    public static class EventNames
    {
        ...
        private
            static 
            readonly 
            string[] SocketIONames = new string[]
            {
                "unknown",
                "connect",
                "disconnect",
        ...
        private
            static
            readonly
            string[] TransportNames = new string[]
            {
                "unknown",
                "open",
                "close",
        ...
        private
            static 
            readonly 
            string[] BlacklistedEvents = new string[]
            {
                "connect",
                "connect_error",
                "connect_timeout",
        ...
        public
            static
            string GetNameFor(SocketIOEventTypes type)
        {
        ...
        public
            static
            string GetNameFor(TransportEventTypes transEvent)
        {
        ...
        public
            static
            bool IsBlacklisted(string eventName)
        {
