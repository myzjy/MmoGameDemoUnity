...
namespace FrostEngine
{
    ...
    public abstract class GameFrameworkSerializer<T>
    {
        ...
        public bool Serialize(Stream stream, T data, byte version)
        {
            ...
            {
                throw new GameFrameworkException(StringUtils.Format("Serialize callback '{}' is not exist.", version));
            }
        ...
        public T Deserialize(Stream stream)
        {
            ...
            {
                throw new GameFrameworkException(StringUtils.Format("Header is invalid, need '{}{}{}', current '{}{}{}'.", (char)header[0], (char)header[1], (char)header[2], (char)header0, (char)header1, (char)header2));
            }
            ...
            {
                throw new GameFrameworkException(StringUtils.Format("Deserialize callback '{}' is not exist.", version));
            }
