...
namespace FrostEngine
{
     ...
     internal sealed class FsmManager : ModuleImp, IFsmManager
    {
        ...
        bool IFsmManager.HasFsm(Type ownerType, string name)
        {
            return HasFsm(ownerType, name);
        }
        ...
        FsmBase IFsmManager.GetFsm(Type ownerType)
        {
            return GetFsm(ownerType);
        }
        ...
        FsmBase IFsmManager.GetFsm(Type ownerType, string name)
        {
            return GetFsm(ownerType, name);
        }
        ...
        public IFsm<T> CreateFsm<T>(string name, T owner, params FsmState<T>[] states) where T : class
        {
            ...
            if (HasFsm<T>(name))
            {
                throw new GameFrameworkException(StringUtils.Format("Already exist FSM '{}'.", typeNamePair));
            }
        ...
        bool IFsmManager.DestroyFsm(Type ownerType)
        {
            return DestroyFsm(ownerType);
        }
        ...
        bool IFsmManager.DestroyFsm(Type ownerType, string name)
        {
            return DestroyFsm(ownerType, name);
        }
