...
namespace FrostEngine
{
    ...
    public sealed class ProcedureModule : Module
    {
        ...
        protected override void Awake()
        {
            ...
            if (_procedureManager == null)
            {
                Debug.Fatal("Procedure manager is invalid.");
            }
        }
        ...
        private IEnumerator Start()
        {
            ...
            {
                Type procedureType = AssemblyUtils.GetTypeByName(availableProcedureTypeNames[i]);
                if (procedureType == null)
                {
                    Debug.LogError("Can not find procedure type '{}'.", availableProcedureTypeNames[i]);
                    yield break;
                }
                ...
                {
                    Debug.LogError("Can not create procedure instance '{}'.", availableProcedureTypeNames[i]);
                    yield break;
                }
