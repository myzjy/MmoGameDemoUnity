...
namespace FrostEngine
{
    ...
    public static class Helper
    {
        ...
        public static T CreateHelper<T>(string helperTypeName, T customHelper, int index) where T : MonoBehaviour
        {
            ...
            {
                System.Type helperType = AssemblyUtils.GetTypeByName(helperTypeName);
                if (helperType == null)
                {
                ...
                {
                    Debug.LogWarning("Type '{}' is not assignable from '{}'.", typeof(T).FullName, helperType.FullName);
                    return null;
                }
            ...
            {
                Debug.LogWarning("You must set custom helper with '{}' type first.", typeof(T).FullName);
                return null;
            }
