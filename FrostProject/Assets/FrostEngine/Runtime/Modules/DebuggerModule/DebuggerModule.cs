...
namespace FrostEngine
{
    ...
    public sealed class DebuggerModule : Module
    {
        /// <summary>
        /// 默认调试器漂浮框大小
        /// </summary>
        ...
        {
            get => debuggerManager.ActiveWindow;
            set
            {
                debuggerManager.ActiveWindow = value;
                enabled = value;
            }
        }
        ...
        protected override void Awake()
        {
            ...
            debuggerManager = ModuleImpSystem.GetModule<IDebuggerManager>();
            if (debuggerManager == null)
            {
                Debug.Fatal("Debugger manager is invalid.");
                return;
            }
