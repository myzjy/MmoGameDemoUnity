...
namespace FrostEngine
{
    ...
    public sealed class RootModules : Module
    {
        ...
        [SerializeField] private string m_VersionHelperTypeName = "FrostEngine.DefaultVersionHelper";

        [SerializeField] private string m_LogHelperTypeName = "FrostEngine.DefaultLogHelper";

        [SerializeField] private string m_JsonHelperTypeName = "FrostEngine.DefaultJsonHelper";
       ...
       /// <summary>
        ...
        //     }
        //
        //     StringUtils.ITextHelper textHelper = (StringUtils.ITextHelper)Activator.CreateInstance(textHelperType);
        //     if (textHelper == null)
        //     {
        ...
        //     }
        //
        //     StringUtils.SetTextHelper(textHelper);
        // }
        ...
        private void InitVersionHelper()
        {
            ...
            Type versionHelperType = AssemblyUtils.GetTypeByName(m_VersionHelperTypeName);
            if (versionHelperType == null)
            {
                throw new GameFrameworkException(StringUtils.Format("Can not find version helper type '{}'.", m_VersionHelperTypeName));
            }

            Version.IVersionHelper versionHelper = (Version.IVersionHelper)Activator.CreateInstance(versionHelperType);
            if (versionHelper == null)
            {
                throw new GameFrameworkException(StringUtils.Format("Can not create version helper instance '{}'.", m_VersionHelperTypeName));
            }
        ...
        private void InitLogHelper()
        {
            ...
            Type logHelperType = AssemblyUtils.GetTypeByName(m_LogHelperTypeName);
            if (logHelperType == null)
            {
                throw new GameFrameworkException(StringUtils.Format("Can not find log helper type '{}'.", m_LogHelperTypeName));
            }

            GameFrameworkLog.ILogHelper logHelper = (GameFrameworkLog.ILogHelper)Activator.CreateInstance(logHelperType);
            if (logHelper == null)
            {
                throw new GameFrameworkException(StringUtils.Format("Can not create log helper instance '{}'.", m_LogHelperTypeName));
            }
