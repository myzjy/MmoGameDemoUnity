...
namespace FrostEngine
{
    ...
    public class DefaultSettingHelper : SettingHelperBase
    {
        ...
        public override bool Load()
        {
            ...
            {
                Debug.LogWarning("Load settings failure with exception '{}'.", exception);
                return false;
            }
        }
        ...
        public override bool Save()
        {
            ...
            {
                Debug.LogWarning("Save settings failure with exception '{}'.", exception);
                return false;
            }
        }
        ...
        {
            return JsonConvert.DeserializeObject(GetString(settingName), objectType);
        }
