...
namespace FrostEngine
{
    ...
    internal sealed partial class ObjectPoolManager : ModuleImp, IObjectPoolManager
    {
        ...
        public bool HasObjectPool(Type objectType)
        {
            ...
            {
                throw new GameFrameworkException(StringUtils.Format("Object type '{}' is invalid.", objectType.FullName));
            }
            ...
            int priority) where T : ObjectBase
        {
            ...
            {
                throw new GameFrameworkException(StringUtils.Format("Already exist object pool '{}'.", typeNamePair));
            }
