...
namespace FrostEngine.Editor
{
      internal sealed class HelperInfo<T> where T : MonoBehaviour
    {
        ...
        {
            m_HelperTypeName = serializedObject.FindProperty(StringUtils.Format("m_{}HelperTypeName", m_Name));
            m_CustomHelper = serializedObject.FindProperty(StringUtils.Format("m_Custom{}Helper", m_Name));
        }
