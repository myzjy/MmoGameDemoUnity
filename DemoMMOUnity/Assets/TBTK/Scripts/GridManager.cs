...
namespace TBTK
{
    public enum _GridType
    {
        SquareGrid,
        HexGrid,
    }

    public enum _GridColliderType
    {
        Master,
        Individual,
    }
    ...
    public class GridManager : MonoBehaviour
    {
        ...
        [Space(8)] public _GridType gridType;

        public static _GridType GetGridType()
        {
            return instance.cacheGridType;
        }

        public static bool IsSquareGrid()
        {
            return GetGridType() == _GridType.SquareGrid;
        }

        public static bool IsHexGrid()
        {
            return GetGridType() == _GridType.HexGrid;
        }

        public _GridColliderType colliderType;

        public static bool UseMasterCollider()
        {
            return instance.cacheColliderType == _GridColliderType.Master;
        }

        public static bool UseIndividualCollider()
        {
            return instance.cacheColliderType == _GridColliderType.Individual;
        }


        public enum _RangeCalculation
        {
            ByNode,
            ByDistance
        }
        ...
        public static bool EnableDiagonalNeighbour()
        {
            return instance.cacheDiagonalNeighbour;
        }
        ...
        public static float GetNodeSpacing()
        {
            return instance.cacheNodeSpacing;
        }

        public static float GetNodeSize(bool addSpacing = true)
        {
            return instance._GetNodeSize(addSpacing);
        }
        ...
        [Space(8)] public int dimensionX = 50;

        public static int DimensionX()
        {
            return instance.cacheDimensionX;
        }

        public int dimensionZ = 50;

        public static int DimensionZ()
        {
            return instance.cacheDimensionZ;
        }
        ...
        public float GetOffsetX()
        {
            ...
            if (IsHexGrid())
                offsetX = DimensionX() * GetNodeSize() * GridGenerator.spaceXHex / 2f -
                          0.5f * GetNodeSize() * GridGenerator.spaceXHex;
            return offsetX;
        }
        ...
        public float GetOffsetZ()
        {
            ...
            if (IsHexGrid())
                offsetZ = DimensionZ() * GetNodeSize() * GridGenerator.spaceZHex / 2f -
                          0.5f * GetNodeSize() * GridGenerator.spaceZHex;
            return offsetZ;
        }
        ...
        public void SetupMasterCollider()
        {
            ...
            if (masterColliderObj == null)
            {
                ...
                masterColliderObj.name = "Collider";
                masterColliderObj.layer = 30;
                masterColliderObj.GetComponent<MeshRenderer>().enabled = false;
            }

            masterColliderObj.transform.localScale =
                new Vector3(DimensionX() * GetNodeSize(), DimensionZ() * GetNodeSize(), 1);
        ...
        {
            if (debugging)
                Debug.Log("CheckLOS  " + node1.GetPos() + "  " + node2.GetPos() + "   " +
                          GridManager.GetDistance(node1, node2));
            ...
            for (int i = 0; i < nList1.Count; i++)
            {
                for (int n = 0; n < nList2.Count; n++)
                {
                    ...
                    if (debugging)
                        Debug.DrawLine(nList1[i].GetPos(), nList2[n].GetPos(), visible ? Color.white : Color.red, 1);
        ...
        public static List<Node> GetSideStepNeighbours(Node srcNode, Node tgtNode)
        {
            ...
            Node n1 = GetSideStepNeighbour(srcNode, tgtNode, 1);
            if (n1 != null) list.Add(n1);
            Node n2 = GetSideStepNeighbour(srcNode, tgtNode, -1);
        ...
        //list of node under the effect of scan-fog-of-war ability
        private List<Node> scannedNodeList = new List<Node>();

        public static void AddScannedNode(Node node)
        {
            instance.scannedNodeList.Add(node);
        }
        ...
        public static void EndTurn()
        {
            for (int i = 0; i < instance.scannedNodeList.Count; i++)
            {
                ...
                {
                    instance.scannedNodeList.RemoveAt(i);
                    i -= 1;
                }
            }
        }
        ...
        public static List<List<Node>> GetGrid()
        {
        ...
        {
            return instance.dimensionX * instance.dimensionZ;
        }
        ...
        public static Node GetNode(Vector3 point, GameObject obj)
        {
            ...
            if (IsSquareGrid())
            {
                ...
                Vector3 worldOffset =
                    GetNode(0, 0).objT.parent.position / GetNodeSize(); //for when the grid is moved from (0, 0, 0)
                coor.x -= worldOffset.x;
                coor.y -= worldOffset.z;
        ...
        public static float GetAngle(Node n1, Node n2, bool round)
        {
            return GetAngle(n1.GetPos(), n2.GetPos(), round);
        }
        ...
        public static List<Node> GetDeploymentNode(int facID)
        {
            return instance._GetDeploymentNode(facID);
        }
        ...
        public static List<Node> GetWalkableList()
        {
            return instance.walkableList;
        }

        public static List<Node> GetAttackableList()
        {
        ...
        {
            SetupWalkableList(unit);
            SetupAttackableList(unit);
        }
        ...
        public static void ClearSelectUnit()
        {
            ...
            instance.walkableList = new List<Node>();
            instance.attackableList = new List<Node>();
        }
        ...
        /// <returns></returns>
        public static bool CanMoveTo(Node node)
        {
            return instance.walkableList != null && instance.walkableList.Contains(node);
        }

        /// <summary>
        /// 能否攻击
        /// </summary>
        /// <param name="node">传递点击的格子</param>
        /// <returns></returns>
        public static bool CanAttack(Node node)
        {
            return node.unit != null && instance.attackableList != null && instance.attackableList.Contains(node);
        }
        ...
        public static void PreviewAttackableNode(Node node)
        {
            instance._PreviewAttackableNode(node);
        }
        ...
        public static bool InAbilityTargetList(Node node)
        {
            return instance.abilityTargetList.Contains(node);
        }
        ...
        public static void SetupAbilityTargetList(Unit unit, Ability ability)
        {
            ...
            if (ability.TargetStraightLineOnly())
            {
                ...
                for (int i = 0; i < (IsHexGrid() ? 6 : 4); i++)
                {
                    ...
                    {
                        if (GetDistance(unit.node, list[n]) < rangeMin)
                        {
                            list.RemoveAt(n);
                            n -= 1;
                        }
                            ...
                            else
                            {
                                ...
                                if (ability.targetType == Ability._TargetType.AllUnit)
                                    instance.abilityTargetList.Add(list[n]);
                                         ...
                                         !OnSameFac(list[n].unit, unit)) instance.abilityTargetList.Add(list[n]);
        ...
        public static void SetupAbilityTargetList(Ability ability, List<Node> list, int facID, Node origin)
        {
            ...
            if (ability.isUnitAbility && rangeMin > 0)
            {
                for (int i = 0; i < list.Count; i++)
                {
                    if (GetDistance(origin, list[i]) < rangeMin)
                    {
                        list.RemoveAt(i);
                        i -= 1;
                    }
            ...
            if (ability.isUnitAbility && ability.requireLos && origin.unit != null)
            {
                for (int i = 0; i < list.Count; i++)
                {
                    if (!CheckLOS(origin, list[i], origin.unit.GetSight()))
                    {
                        list.RemoveAt(i);
                        i -= 1;
                    }
            ...
            else if (ability.targetType == Ability._TargetType.HostileUnit)
            {
                for (int i = 0; i < list.Count; i++)
                {
                    if (list[i].unit != null && list[i].unit.GetFacID() != facID)
                        instance.abilityTargetList.Add(list[i]);
                }
            }
            else if (ability.targetType == Ability._TargetType.FriendlyUnit)
            {
        ...
        public static List<Node> GetTargetNodeForNonTargetingFAbility(Ability ability)
        {
            ...
            else if (ability.targetType == Ability._TargetType.HostileUnit)
            {
                ...
                {
                    if (uList[i].GetFacID() != ability.facID) list.Add(uList[i].node);
                }
            }
            else if (ability.targetType == Ability._TargetType.FriendlyUnit)
            {
        ...
        public static List<Node> GetNodesInACircle(Node srcNode, int range, bool walkableOnly = true)
        {
            ...
            {
                if (Vector3.Distance(srcNode.GetPos(), tgtList[i].GetPos()) > dist)
                {
                    tgtList.RemoveAt(i);
                    i -= 1;
                }
        ...
        public static List<Node> GetNodesInACone(Node srcNode, Node tgtNode, int range, int rangeMin, int fov,
        ...
        public static List<Node> GetNodesInALine(Node srcNode, float angle, int dist, int rangeMin,
            bool walkableOnly = false)
        {
            List<Node> list = new List<Node>();
        ...
        public static List<Node> GetNodesWithinDistance(Node srcNode, int dist, bool walkableOnly = false,
            bool allowUnit = false, bool allowObs = false, int apLimit = 0)
        {
            return GetNodesWithinDistance(srcNode, dist, walkableOnly, AStar.BypassUnitCode(allowUnit), allowObs,
                apLimit);
        }

        public static List<Node> GetNodesWithinDistance(Node srcNode, int dist, bool walkableOnly, int allowUnit,
            bool allowObs, int apLimit = 0)
        {
                ...
                for (int n = 0; n < openList.Count; n++)
                {
                    ...
                    for (int m = 0; m < neighbourList.Count; m++)
                    {
                        ...
                        if (!closeList.Contains(neighbour) && !openList.Contains(neighbour) &&
                            !newOpenList.Contains(neighbour))
                        {
            ...
            if (IsSquareGrid() && EnableDiagonalNeighbour() &&
                instance.rangeCalculation == _RangeCalculation.ByDistance)
            {
        ...
        */
        ...
        public static List<Node> GetSpawnGroup(int facID, int areaID)
        {
            ...
            for (int x = 0; x < instance.grid.Count; x++)
            {
                for (int z = 0; z < instance.grid[x].Count; z++)
                {
                    ...
                    if (instance.grid[x][z].spawnGroupFacID == facID && instance.grid[x][z].spawnGroupID == areaID)
                        list.Add(instance.grid[x][z]);
                }
            }
        ...
        public static bool OnSameFac(Unit unit1, Unit unit2)
        {
            return unit1.GetFacID() == unit2.GetFacID();
        }
            ...
            for (int x = 0; x < grid.Count; x++)
            {
                for (int z = 0; z < grid[x].Count; z++)
                {
                    ...
                    if (grid[x][z].spawnGroupFacID >= 0)
                    {
                        ...
                        float size = nodeSize * 0.25f;
                        Vector3 pos = grid[x][z].GetPos() + new Vector3(0, .1f, 0);
                        Gizmos.DrawLine(pos + new Vector3(1, 0, 1).normalized * size,
                            pos - new Vector3(1, 0, 1).normalized * size);
                        Gizmos.DrawLine(pos + new Vector3(-1, 0, 1).normalized * size,
                            pos - new Vector3(-1, 0, 1).normalized * size);
                    }
                    ...
                    if (drawAPCost)
                    {
                        Handles.Label(grid[x][z].GetPos() + new Vector3(0, 0.25f, 0) * nodeSize,
                            grid[x][z].cost.ToString());
                    }
#endif
                }
            }
