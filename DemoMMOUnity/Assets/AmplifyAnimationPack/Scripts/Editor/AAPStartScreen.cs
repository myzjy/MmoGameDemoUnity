...
namespace AmplifyAnimationPack
{
    public class AAPStartScreen : EditorWindow
    {
        ...
        private static readonly string AnimCatalogueURL =
            "http://wiki.amplify.pt/index.php?title=Unity_Products:Amplify_Animation_Pack/AnimCat";
        ...
        private static readonly GUIContent LearningResourcesTitle = new GUIContent("Learning Resources",
            "Check the online wiki for various topics about how to use AAP");

        private static readonly GUIContent CommunityTitle = new GUIContent("Community",
            "Need help? Reach us through our discord server or the official support Unity forum");

        private static readonly GUIContent UpdateTitle = new GUIContent("Latest Update",
            "Check the lastest additions, improvements and bug fixes done to AAP");

        private static readonly GUIContent DependenciesTitle = new GUIContent("Dependencies",
            "List of package dependencies that need to be installed for AAP to properly work.");

        private static readonly GUIContent AAPTitle =
            new GUIContent("Amplify Animation Pack", "Are you using the latest version? Now you know");

        private static readonly GUIContent ProjectSettingsTitle =
            new GUIContent("Project Settings", "Settings required for AAP to properly work.");
        ...
        [NonSerialized] private Texture m_textIcon = null;
        ...
        [NonSerialized] private GUIStyle m_buttonLeftStyle = null;
        [NonSerialized] private GUIStyle m_buttonRightStyle = null;
        [NonSerialized] private GUIStyle m_minibuttonStyle = null;
        ...
        {
            AAPStartScreen window =
                (AAPStartScreen)GetWindow(typeof(AAPStartScreen), true, "Amplify Animation Pack Start Screen");
        ...
        private void OnEnable()
        {
            ...
            if (m_AAPIcon == null)
            {
                m_AAPIcon = new GUIContent(
                    AssetDatabase.LoadAssetAtPath<Texture2D>(AssetDatabase.GUIDToAssetPath(AAPIconGUID)));
            }
        ...
        public bool ForceAsmdefUpdate
        {
            get { return m_forceAsmdefUpdate; }
        }
        ...
        public void OnGUI()
        {
            ...
            if (!m_infoDownloaded)
            {
                ...
                StartBackgroundTask(StartRequest(ChangelogURL, () =>
                {
                    ...
                    int revision = ((m_changeLog.Version / 10) - major * 1000 - minor * 100 - release * 10) +
                                   (m_changeLog.Version - major * 10000 - minor * 1000 - release * 100);
            ...
            if (m_linkStyle == null)
            {
                var inv = AssetDatabase.LoadAssetAtPath<Texture2D>(
                    AssetDatabase.GUIDToAssetPath(
                        "1004d06b4b28f5943abdf2313a22790a")); // find a better solution for transparent buttons
                    ...
                    GUILayout.BeginVertical(GUILayout.Width(250));
                    {
                        ...
                        if (checkValue)
                        {
                            ...
                            if (GUILayout.Button("Fix"))
                            {
                                ...
                                SerializedObject timeManagerObject =
                                    new SerializedObject(AssetDatabase.LoadAllAssetsAtPath(TimeManagerAssetPath)[0]);
                                SerializedProperty fixedTimestepProperty =
                                    timeManagerObject.FindProperty("Fixed Timestep");
            ...
            EditorGUILayout.BeginHorizontal("ProjectBrowserBottomBarBg", GUILayout.ExpandWidth(true),
                GUILayout.Height(22));
            {
                GUILayout.FlexibleSpace();
                ...
                m_startup = (AAPPreferences.ShowOption)EditorGUILayout.EnumPopup("Show At Startup", m_startup,
                    GUILayout.Width(220));
