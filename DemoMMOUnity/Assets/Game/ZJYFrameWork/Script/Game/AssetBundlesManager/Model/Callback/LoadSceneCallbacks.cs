...
namespace ZJYFrameWork.Module.Scenes.Callbacks
{
    ...
    public sealed class LoadSceneCallbacks
    {
        ...
        public void DefaultOnLoadSceneFailureCallback(string sceneAssetName, LoadResourceStatus status,
            string errorMessage, object userData)
        {
            throw new Exception(StringUtils.Format(
                "Asset [sceneAssetName:{}] is invalid, [status:{}] [errorMessage:{}] [userData:{}]"
        ...
        public void DefaultOnLoadSceneDependencyAssetCallback(string sceneAssetName, string dependencyAssetName,
            int loadedCount, int totalCount, object userData)
        {
            Debug.Log(
                "DefaultOnLoadSceneDependencyAssetCallback [sceneAssetName:{}], [dependencyAssetName:{}] [loadedCount:{}] [totalCount:{}] [userData:{}]",
