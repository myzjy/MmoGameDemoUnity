...
namespace XLua
{
    public partial class DelegateBridge_Wrap : DelegateBridge
    {
		...
		public long __Gen_Delegate_Imp2(long p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp3(long p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public long __Gen_Delegate_Imp4(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(float p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(long p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(long p0, long p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Func<long, long>(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(System.Func<long, string>))
			{
			    return new System.Func<long, string>(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(System.Func<string, long>))
			{
			    return new System.Func<string, long>(__Gen_Delegate_Imp4);
			}
			...
			{
			    return new System.Action<float, float>(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<long>))
			{
			    return new UnityEngine.Events.UnityAction<long>(__Gen_Delegate_Imp9);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<long, long>))
			{
			    return new UnityEngine.Events.UnityAction<long, long>(__Gen_Delegate_Imp10);
			}
