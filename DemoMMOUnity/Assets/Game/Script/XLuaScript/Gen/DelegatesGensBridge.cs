...
namespace XLua
{
    public partial class DelegateBridge_Wrap : DelegateBridge
    {
		...
		public void __Gen_Delegate_Imp12(long p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp13(long p0, long p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp15(string p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLua.LuaEnv __Gen_Delegate_Imp17(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UnityEngine.Events.UnityAction<long>(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<long, long>))
			{
			    return new UnityEngine.Events.UnityAction<long, long>(__Gen_Delegate_Imp13);
			}
