        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					var gen_ret = new System.Uri(_uriString);
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && translator.Assignable<System.UriKind>(L, 3))
				{
					...
					var gen_ret = new System.Uri(_uriString, _uriKind);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Uri>(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
					...
					var gen_ret = new System.Uri(_baseUri, _relativeUri);
					translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.Uri.CheckHostName( _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.UriPartial _part;translator.Get(L, 2, out _part);
                        ...
                        var gen_ret = gen_to_be_invoked.GetLeftPart( _part );
		    ...
		    try {
                ...
                
                {
                    char _character = (char)LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = System.Uri.HexEscape( _character );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = System.Uri.HexUnescape( _pattern, ref _index );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = System.Uri.IsHexEncoding( _pattern, _index );
		    ...
		    try {
                ...
                
                {
                    string _schemeName = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.Uri.CheckSchemeName( _schemeName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    char _character = (char)LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = System.Uri.IsHexDigit( _character );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    char _digit = (char)LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = System.Uri.FromHex( _digit );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Uri _uri = (System.Uri)translator.GetObject(L, 2, typeof(System.Uri));
                        ...
                        var gen_ret = gen_to_be_invoked.MakeRelativeUri( _uri );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<System.UriKind>(L, 2)) 
                {
                    ...
                    System.Uri _result;
                        ...
                        var gen_ret = System.Uri.TryCreate( _uriString, _uriKind, out _result );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Uri>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    System.Uri _result;
                        ...
                        var gen_ret = System.Uri.TryCreate( _baseUri, _relativeUri, out _result );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                    translator.Push(L, _result);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.UriFormat _format;translator.Get(L, 3, out _format);
                        ...
                        var gen_ret = gen_to_be_invoked.GetComponents( _components, _format );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.StringComparison _comparisonType;translator.Get(L, 5, out _comparisonType);
                        ...
                        var gen_ret = System.Uri.Compare( _uri1, _uri2, _partsToCompare, _compareFormat, _comparisonType );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_IsWellFormedOriginalString(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.IsWellFormedOriginalString(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.UriKind _uriKind;translator.Get(L, 2, out _uriKind);
                        ...
                        var gen_ret = System.Uri.IsWellFormedUriString( _uriString, _uriKind );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _stringToUnescape = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.Uri.UnescapeDataString( _stringToUnescape );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _stringToEscape = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.Uri.EscapeUriString( _stringToEscape );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _stringToEscape = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = System.Uri.EscapeDataString( _stringToEscape );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Uri _uri = (System.Uri)translator.GetObject(L, 2, typeof(System.Uri));
                        ...
                        var gen_ret = gen_to_be_invoked.IsBaseOf( _uri );
                        LuaAPI.lua_pushboolean(L, gen_ret);
