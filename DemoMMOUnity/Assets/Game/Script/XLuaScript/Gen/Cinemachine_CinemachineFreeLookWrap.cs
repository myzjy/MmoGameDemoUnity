        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Cinemachine.CinemachineFreeLook();
		    ...
		    try {
                ...
                
                {
                    int _i = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetRig( _i );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _t = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetLocalPositionForCameraFromInput( _t );
