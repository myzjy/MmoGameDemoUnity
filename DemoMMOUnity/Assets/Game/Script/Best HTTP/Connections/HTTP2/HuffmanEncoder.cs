...
namespace BestHTTP.Connections.HTTP2
{
    ...
    static class HuffmanEncoder
    {
        ...
        public struct TableEntry
        {
            ...
            /// <summary>
            /// 它必须在位索引处返回0或1。索引将相对于表示当前代码的比特。Idx从左到右生长。Idx必须在[1..Bits]之间。
            /// </summary>
        ...
        public struct TreeNode
        {
            ...
            public override string ToString()
            {
                ...
                stringBuilder.Append($"[TreeNode Value: {this.Value},");
                stringBuilder.Append($" NextZeroIdx: {this.NextZeroIdx}, ");
                stringBuilder.Append($"NextOneIdx: {this.NextOneIdx}]");
                return $"{stringBuilder}";
            }
        }

        private static readonly TableEntry[] StaticTable = new TableEntry[]
        {
        ...
        private static readonly TreeNode[] HuffmanTree = new TreeNode[]
        {
