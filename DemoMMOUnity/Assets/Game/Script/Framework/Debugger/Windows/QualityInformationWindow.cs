    ...
    public sealed class QualityInformationWindow : ScrollableDebuggerWindowBase
    {
        ...
        protected override void OnDrawScrollableWindow()
        {
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                applyExpensiveChanges = GUILayout.Toggle(applyExpensiveChanges,
            ...
            GUILayout.BeginVertical("box");
            {
                ...
                DrawItem("Async Upload Time Slice",
                    StringUtils.Format("{} ms", QualitySettings.asyncUploadTimeSlice.ToString()));
                DrawItem("Async Upload Buffer Size",
                    StringUtils.Format("{} MB", QualitySettings.asyncUploadBufferSize.ToString()));
