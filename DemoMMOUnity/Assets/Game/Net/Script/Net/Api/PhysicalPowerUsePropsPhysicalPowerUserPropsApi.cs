...
namespace ZJYFrameWork.Net
{
	...
	/// 使用体力
	/// </summary>
	public class PhysicalPowerUsePropsPhysicalPowerUserPropsApi : ApiHttp<PhysicalPowerUsePropsPhysicalPowerUserPropsRequest, PhysicalPowerUsePropsPhysicalPowerUserPropsResponse, Error>
	{
